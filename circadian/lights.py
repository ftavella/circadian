...
# %% ../nbs/api/01_lights.ipynb #b8401927
import inspect
import warnings
import numpy as np
import pylab as plt
...
# %% ../nbs/api/01_lights.ipynb #b6fe60f9
class LightSchedule:
...
# %% ../nbs/api/01_lights.ipynb #eeb2c473
...
# %% ../nbs/api/01_lights.ipynb #4236b014
@patch_to(LightSchedule)
def __sub__(self,
            schedule: 'LightSchedule' # another LightSchedule object
            ) -> 'LightSchedule':
...
# %% ../nbs/api/01_lights.ipynb #326680c3
@patch_to(LightSchedule)
...
# %% ../nbs/api/01_lights.ipynb #5d76f359
@patch_to(LightSchedule)
def plot(self, 
...
# %% ../nbs/api/01_lights.ipynb #1c57eac1
@patch_to(LightSchedule)
...
# %% ../nbs/api/01_lights.ipynb #b9188fd2
@patch_to(LightSchedule)
...
# %% ../nbs/api/01_lights.ipynb #716b1b96
@patch_to(LightSchedule)
...
# %% ../nbs/api/01_lights.ipynb #59d70c7b
@patch_to(LightSchedule)
...
# %% ../nbs/api/01_lights.ipynb #accaabab
@patch_to(LightSchedule)
...
# %% ../nbs/api/01_lights.ipynb #62e99456
@patch_to(LightSchedule)
...
# %% ../nbs/api/01_lights.ipynb #b26b5e52
...
# %% ../nbs/api/01_lights.ipynb #128ec7e8
@patch_to(LightSchedule)

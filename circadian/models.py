...
# %% auto #0
__all__ = ['DynamicalTrajectory', 'CircadianModel', 'Forger99', 'Hannay19', 'Hannay19TP', 'Jewett99', 'Hilaire07', 'Breslow13',
           'Skeldon23']

# %% ../nbs/api/00_models.ipynb #87dea19d
import warnings
import numpy as np
from abc import ABC
...
# %% ../nbs/api/00_models.ipynb #610221d8
...
# %% ../nbs/api/00_models.ipynb #a243ff55
...
# %% ../nbs/api/00_models.ipynb #edbe765d
...
# %% ../nbs/api/00_models.ipynb #01adacc8
@patch_to(DynamicalTrajectory)
...
# %% ../nbs/api/00_models.ipynb #c0d38868
@patch_to(DynamicalTrajectory)
def __len__(self) -> int:
    return len(self.time)

# %% ../nbs/api/00_models.ipynb #7e35b445
@patch_to(DynamicalTrajectory)
...
# %% ../nbs/api/00_models.ipynb #dedeebc2
@patch_to(DynamicalTrajectory)
# String method
...
# %% ../nbs/api/00_models.ipynb #541e1ac0
...
# %% ../nbs/api/00_models.ipynb #0dd48ce7
...
# %% ../nbs/api/00_models.ipynb #54704962
...
# %% ../nbs/api/00_models.ipynb #ee67b919
@patch_to(CircadianModel)
def step_rk4(self,
             t: float, # time
             state: np.ndarray, # dynamical state of the model
...
# %% ../nbs/api/00_models.ipynb #aca877e5
@patch_to(CircadianModel)
def integrate(self,
...
# %% ../nbs/api/00_models.ipynb #a895e2b7
@patch_to(CircadianModel)
def __call__(self,
...
# %% ../nbs/api/00_models.ipynb #63cab478
@patch_to(CircadianModel)
...
# %% ../nbs/api/00_models.ipynb #263d37e7
@patch_to(CircadianModel)
def phase(self,
...
# %% ../nbs/api/00_models.ipynb #650bf8a1
@patch_to(CircadianModel)
def amplitude(self,
...
# %% ../nbs/api/00_models.ipynb #41a4d104
@patch_to(CircadianModel)
def cbt(self,
...
# %% ../nbs/api/00_models.ipynb #fd49babc
@patch_to(CircadianModel)
def dlmos(self,
...
# %% ../nbs/api/00_models.ipynb #57f83ce8
@patch_to(CircadianModel)
def equilibrate(self,
    ...
    if total_time % 24 > dt or total_time % 24 < 24 - dt:
...
# %% ../nbs/api/00_models.ipynb #b208b559
...
# %% ../nbs/api/00_models.ipynb #00208627
...
# %% ../nbs/api/00_models.ipynb #59350df9
@patch_to(Forger99)
def derv(self, 
         t: float, # time
...
# %% ../nbs/api/00_models.ipynb #03d86dcc
@patch_to(Forger99)
def phase(self,
...
# %% ../nbs/api/00_models.ipynb #97d61b72
@patch_to(Forger99)
def amplitude(self,
...
# %% ../nbs/api/00_models.ipynb #39f87d88
@patch_to(Forger99)
def cbt(self,
...
# %% ../nbs/api/00_models.ipynb #f89034a1
@patch_to(Forger99)
def dlmos(self,
...
# %% ../nbs/api/00_models.ipynb #7ee1c5b2
...
# %% ../nbs/api/00_models.ipynb #b060f1db
@patch_to(Hannay19)
def derv(self,
         t: float, # time
...
# %% ../nbs/api/00_models.ipynb #fe7ff655
@patch_to(Hannay19)
def phase(self,
          trajectory: DynamicalTrajectory=None, # trajectory to calculate the phase. If None, the current trajectory is used
          time: float=None # a time point to calculate the phase at. If None, the phase is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #e1fc3013
@patch_to(Hannay19)
def amplitude(self,
              trajectory: DynamicalTrajectory=None, # trajectory to calculate the amplitude. If None, the current trajectory is used
              time: float=None # a time point to calculate the amplitude at. If None, the amplitude is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #bed0247d
@patch_to(Hannay19)
def cbt(self,
        trajectory: DynamicalTrajectory=None # trajectory to calculate the cbt. If None, the current trajectory is used
        ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #2f7fe295
@patch_to(Hannay19)
def dlmos(self,
          trajectory: DynamicalTrajectory=None # trajectory to calculate the dlmo. If None, the current trajectory is used
          ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #a1b3da96
...
# %% ../nbs/api/00_models.ipynb #eb44d773
@patch_to(Hannay19TP)
def derv(self,
         t: float, # time
...
# %% ../nbs/api/00_models.ipynb #9a883c19
@patch_to(Hannay19TP)
def phase(self,
          trajectory: DynamicalTrajectory=None, # trajectory to calculate the phase. If None, the current trajectory is used
          time: float=None # a time point to calculate the phase at. If None, the phase is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #7e1e3a3d
@patch_to(Hannay19TP)
def amplitude(self,
              trajectory: DynamicalTrajectory=None, # trajectory to calculate the amplitude. If None, the current trajectory is used
              time: float=None # a time point to calculate the amplitude at. If None, the amplitude is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #de11f531
@patch_to(Hannay19TP)
def cbt(self,
        trajectory: DynamicalTrajectory=None, # trajectory to calculate the cbt. If None, the current trajectory is used
        ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #0d17644d
@patch_to(Hannay19TP)
def dlmos(self,
          trajectory: DynamicalTrajectory=None # trajectory to calculate the dlmo. If None, the current trajectory is used
          ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #915507a2
...
# %% ../nbs/api/00_models.ipynb #3a6fd912
@patch_to(Jewett99)
def derv(self,
         t: float, # time
         state: np.ndarray, # dynamical state (x, xc, n)
...
# %% ../nbs/api/00_models.ipynb #d15d1b59
@patch_to(Jewett99)
def phase(self,
          trajectory: DynamicalTrajectory=None, # trajectory to calculate the phase. If None, the current trajectory is used
          time: float=None # a time point to calculate the phase at. If None, the phase is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #0c334ac0
@patch_to(Jewett99)
def amplitude(self,
              trajectory: DynamicalTrajectory=None, # trajectory to calculate the amplitude. If None, the current trajectory is used
              time: float=None # a time point to calculate the amplitude at. If None, the amplitude is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #d90f9942
@patch_to(Jewett99)
def cbt(self,
        trajectory: DynamicalTrajectory=None, # trajectory to calculate the cbt. If None, the current trajectory is used
        ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #be550d2d
@patch_to(Jewett99)
def dlmos(self,
          trajectory: DynamicalTrajectory=None # trajectory to calculate the dlmo. If None, the current trajectory is used
          ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #a0b74140
...
# %% ../nbs/api/00_models.ipynb #0f8942b6
@patch_to(Hilaire07)
def derv(self,
         t: float, # time
         state: np.ndarray, # dynamical state (x, xc, n)
...
# %% ../nbs/api/00_models.ipynb #33e82a6a
@patch_to(Hilaire07)
def phase(self,
          trajectory: DynamicalTrajectory=None, # trajectory to calculate the phase. If None, the current trajectory is used
          time: float=None # a time point to calculate the phase at. If None, the phase is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #c31f383c
@patch_to(Hilaire07)
def amplitude(self,
              trajectory: DynamicalTrajectory=None, # trajectory to calculate the amplitude. If None, the current trajectory is used
              time: float=None # a time point to calculate the amplitude at. If None, the amplitude is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #eb650788
@patch_to(Hilaire07)
def cbt(self,
        trajectory: DynamicalTrajectory=None, # trajectory to calculate the cbt. If None, the current trajectory is used
        ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #0b4f78b2
@patch_to(Hilaire07)
def dlmos(self,
          trajectory: DynamicalTrajectory=None # trajectory to calculate the dlmo. If None, the current trajectory is used
          ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #806e3c31
...
# %% ../nbs/api/00_models.ipynb #a21f36f8
@patch_to(Breslow13)
def derv(self,
         t: float, # time
...
# %% ../nbs/api/00_models.ipynb #07faa368
@patch_to(Breslow13)
def phase(self,
          trajectory: DynamicalTrajectory=None, # trajectory to calculate the phase. If None, the current trajectory is used
          time: float=None # a time point to calculate the phase at. If None, the phase is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #70f433fe
@patch_to(Breslow13)
def amplitude(self,
              trajectory: DynamicalTrajectory=None, # trajectory to calculate the amplitude. If None, the current trajectory is used
              time: float=None # a time point to calculate the amplitude at. If None, the amplitude is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #5c4efc92
@patch_to(Breslow13)
def cbt(self,
        trajectory: DynamicalTrajectory=None, # trajectory to calculate the cbt. If None, the current trajectory is used
        ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #c387c84d
@patch_to(Breslow13)
def dlmos(self,
          trajectory: DynamicalTrajectory=None # trajectory to calculate the dlmo. If None, the current trajectory is used
          ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #c728f6f0
...
# %% ../nbs/api/00_models.ipynb #bb7d16ec
@patch_to(Skeldon23)
def derv(self, 
         t: float, # time
...
# %% ../nbs/api/00_models.ipynb #7ae67ef4
@patch_to(Skeldon23)
def phase(self,
          trajectory: DynamicalTrajectory=None, # trajectory to calculate the phase. If None, the current trajectory is used
          time: float=None # a time point to calculate the phase at. If None, the phase is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #f027049d
@patch_to(Skeldon23)
def amplitude(self,
              trajectory: DynamicalTrajectory=None, # trajectory to calculate the amplitude. If None, the current trajectory is used
              time: float=None # a time point to calculate the amplitude at. If None, the amplitude is calculated for the entire trajectory
...
# %% ../nbs/api/00_models.ipynb #2903a39f
@patch_to(Skeldon23)
def cbt(self,
        trajectory: DynamicalTrajectory=None, # trajectory to calculate the cbt. If None, the current trajectory is used
        ) -> np.ndarray:
...
# %% ../nbs/api/00_models.ipynb #9cf9f39a
@patch_to(Skeldon23)
def dlmos(self,
            trajectory: DynamicalTrajectory=None # trajectory to calculate the dlmo. If None, the current trajectory is used
            ) -> np.ndarray:
